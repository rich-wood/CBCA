...
hold all
xlim([1995,2016])
% ax5=plot([1995:2014],100*stats_p.(['rsd_',regionname])(36:55),'Color','b')
% ax6=plot([1995:2013],100*stats_c.(['rsd_',regionname])(36:54),'Color','r')
...
% legend([ax],[{'RSD PBCA'},{'RSD CBCA'},{'RSD PBCA  - rates'},{'RSD CBCA - rates'}],'location','east')
savefig(['figs\LinePlotsIndexed_',regionname])
print(['figs\LinePlotsIndexed_',regionname],'-djpeg')
% print(['figs\LinePlotsIndexed_',regionname],'-depsc')
